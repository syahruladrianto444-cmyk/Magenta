...
@section('content')
    ...
    <form action="{{ isset($service) ? route('admin.services.update', $service) : route('admin.services.store') }}"
        ...
        <div
            ...
            <div x-data="{
                services: {{ old('offered_services', json_encode($service->offered_services ?? [])) ?: '[{icon: \'briefcase\', title: \'\', desc: \'\'}]' }}
                ...
                <div class="space-y-4">
                    ...
                    <template x-if="services.length === 0">
                        <div class="text-center py-4 text-sm text-gray-500">Belum ada layanan tambahan.</div>
                    </template>
                </div>
            </div>
            ...
            <div x-data="{
                scopes: {{ old('scope_details', json_encode($service->scope_details ?? [])) ?: '[{title: \'\', desc: \'\'}]' }}
            }" class="border-t border-gray-200 dark:border-navy-700 pt-6">
                <div class="flex items-center justify-between mb-4">
                ...
                <div class="space-y-4">
                    ...
                    <template x-if="scopes.length === 0">
                        <div class="text-center py-4 text-sm text-gray-500">Belum ada cakupan.</div>
                    </template>
                </div>
            </div>
